// Generated from TreasuryManagerFactory.
// Source artifact: TreasuryManagerFactory.sol/TreasuryManagerFactory.json (FOUNDRY_PROFILE=arc forge build). Do not hand-edit;
...
export const TreasuryManagerFactoryAbi = [
  ...
  {
    "type": "error",
    "name": "UnknownManagerImplemention",
    "inputs": []
  }
] as const;
