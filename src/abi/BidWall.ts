// Generated from BurningBidWall (the deployed BidWall variant).
// Source artifact: BurningBidWall.sol/BurningBidWall.json (FOUNDRY_PROFILE=arc forge build). Do not hand-edit;
