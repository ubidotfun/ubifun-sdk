// Generated from UsdcMarketCappedPrice (the deployed IInitialPrice implementation).
// Source artifact: UsdcMarketCappedPrice.sol/UsdcMarketCappedPrice.json (FOUNDRY_PROFILE=arc forge build). Do not hand-edit;
